...
#########################################################
# Step 8 : Box Plot of Attendance
########################################################_

print(Border)
print("Step 8 : Box Plot of Attendance")
print(Border)

plt.figure(figsize=(8, 6))
sns.boxplot(data=df, x="FinalResult", y="Attendance")
plt.title("Box Plot of Attendance")
plt.xlabel("Final Result (0 = Failed, 1 = Passed)")
