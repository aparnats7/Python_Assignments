...
def main():   
    ...
    Acc1 = accuracy_score(Training,Y_train)

    Testing = model.predict(X_test)
    Acc2 = accuracy_score(Testing,Y_test)

    print("Training accuracy is:  ",Acc1*100)
    print("Testing accuracy is:  ",Acc2*100)

    #When max_depth=None, the decision tree grows completely and memorizes training data. This leads to overfitting, where training accuracy becomes 100% but testing accuracy decreases because the model fails to generalize to unseen data.
