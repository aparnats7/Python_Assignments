...
def main():
    ...
    print("The accuracy of the model of logistic regression is: ",accuracy_score(Y_test,lr_pred)*100)

    print("The accuracy of the model of KNN is: ",accuracy_score(Y_test,knn_pred)*100)
    ...
    # Create input array
    new_data = [[Pregnancies, Glucose, BloodPressure, SkinThickness,
    ...
    # Output result
    if prediction[0] == 1:
        print("Result: Patient is DIABETIC")
    else:
        print("Result: Patient is NOT DIABETIC")

    #-------------------------------------------------------------------------------
    # Step 7 :- Saving in the CSV
    #-------------------------------------------------------------------------------

    print(Border)
    print("Step 7 :- Saving in the CSV")
    print(Border)
